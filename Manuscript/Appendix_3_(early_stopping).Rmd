...
In contrast to occupancy model, bootstrapping prescribed early stopping for both parameters in all count models (Figure 3.2).  **Again, why so many more iterations for the scoter model?**
