...
variables; i.e., at their mean values* **BH: Did you do this?**) and the occupancy, conditional mean abundance, and 
...
(and any abbreviations) are defined in detail in Appendix 2. **Only effects which were selected to be stable (see Appendix 1) were depicted. [Add same for appendix 6 and 7]**

## Occupancy
```{r occ, out.extra=sprintf('angle=%d', c(90, rep(0, 8)))}
# xkm, ykm
