...
All occupancy models converged to the maximum likelihood estimates (i.e., did not stop early; Figure 4.1).  Failure to stop early sometimes happens in data sets with many observations and strong effects [see comment of Kneib in @Buhlmann2014].  This suggests that the effects of the environmental variables on sea duck occupancy are rather complex.  
...
In contrast to occupancy model, bootstrapping prescribed early stopping for both parameters in all count models (Figure 4.2).
